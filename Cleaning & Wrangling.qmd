...
repro_DAUPUS <- repro_fill[which(repro_fill$Sp_Code == "DAUPUS"),]
...
repro_LUPBIC <- repro_fill[which(repro_fill$Sp_Code == "LUPBIC"),]
...
repro_MADGRA <- repro_fill[which(repro_fill$Sp_Code == "MADGRA"),]
...
repro_MICCAL <- repro_fill[which(repro_fill$Sp_Code == "MICCAL"),]
...
repro_fill_hi_n_narm <- repro_fill_hi_n[-(which(repro_fill_hi_n$total_fl_mass_ln %in% c(NA, -Inf))),]
