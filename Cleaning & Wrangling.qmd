...
To-do:
Fix slopes
Make line graphs prettier
Make bar graph of slopes and figure out how to make residuals or something into error bars
Add faded point to the significant graph
...
bar graph of degree of invasiveness
...
Now make a bar graph of growth habit and native status 
...
Now make a bar graph of growth habit and native rating
...
Bar graph of population by native status
...
Bar graph of population by rating
...
bar graph of population by growth habit
...
bar graph with only species found in multiple populations, clustered by species
