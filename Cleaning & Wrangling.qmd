...
GALPAR, Holvir, miccal not working
...
Double check that the numbers of values per species aligns with number of images per species folder. Then merge with Licor dataset by plant ID.

AVEBAR: missing 1
j4.AVEBAR.2 blank

BROHOR: missing 1
H5.BROHOR.2 ruler present
